G.AddData({
    ...
    func:function()
    {
        ...
        G.getDict('artisan').effects.push({type:'convert',from:{'purple pepper':3,'herb':3},into:{'purple sauce':1},every:3,mode:'purple sauce'});
        ...
        new G.Trait({
            ...
            effects:[
                {type:'function',func:function(){G.getDict('purple sauce').turnToByContext['eat']['happiness']=0.2;}},//this is a custom function executed when we gain the trait
            ],
        });
